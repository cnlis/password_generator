...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/ui/icons/app-icon.ico", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/ui/icons/lock.svg", QSize(), QIcon.Disabled, QIcon.On)
...
"}")
        ...
        self.frame_password.setLineWidth(1)
        ...
        self.btn_visibility.setStyleSheet(u"")
        icon2 = QIcon()
        icon2.addFile(u":/icons/ui/icons/invisible.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/icons/ui/icons/visible.svg", QSize(), QIcon.Normal, QIcon.On)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/icons/ui/icons/refresh.svg", QSize(), QIcon.Normal, QIcon.On)
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/icons/ui/icons/copy.svg", QSize(), QIcon.Normal, QIcon.On)
